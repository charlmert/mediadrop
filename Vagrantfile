...
Vagrant.configure("2") do |config|
  ...
  # config.vm.synced_folder "/Users/charl/projects/captive-portal-server", "/var/www/xgateway", type: 'nfs'
  # config.vm.synced_folder "/Users/charl/projects/routenetworks.africa.signup", "/var/www/routenetworks", type: 'nfs'

  config.vm.synced_folder "./", "/var/www/mediadrop", type: 'virtualbox'

  # config.vm.synced_folder "/Users/charl/projects/captive-portal-server", "/var/www/xgateway", type: 'rsync'
  # config.vm.synced_folder "/Users/charl/projects/routenetworks.africa.signup", "/var/www/routenetworks", type: 'rsync'
